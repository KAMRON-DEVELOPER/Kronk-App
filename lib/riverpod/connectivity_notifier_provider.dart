...
final asyncConnectivityNotifierProvider = AutoDisposeAsyncNotifierProvider<AsyncConnectivityNotifier, bool>(() => AsyncConnectivityNotifier());

class AsyncConnectivityNotifier extends AutoDisposeAsyncNotifier<bool> {
  late Connectivity _connectivity;
  late StreamSubscription<List<ConnectivityResult>> _streamSubscription; // ignore: unused_field
