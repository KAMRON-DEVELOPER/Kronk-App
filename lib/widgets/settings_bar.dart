...
//  final String currentTheme = Hive.box('settingsBox').get('theme', defaultValue: 'dark');
//
...
//                    Text(
//                      'Themes',
//                      style: TextStyle(fontSize: 20.0, color: theme.text3),
//                    ),
//                    const SizedBox(height: 8),
//                    SizedBox(
//                      height: 84,
//                      child: LayoutBuilder(builder: (context, constraints) {
//                        final separatorWidth = (constraints.maxWidth - (itemWidth * themes.length)) / (themes.length - 1);
...
//                                GestureDetector(
//                                  onTap: () {
//                                    // themeProvider.changeTheme(themes[index]['name'])
//                                  },
//                                  child: Container(
//                                    width: itemWidth,
//                                    height: itemWidth,
...
//                                      border: Border.all(
//                                        color: currentTheme == themes[index]['name'] ? Colors.blueAccent : Colors.transparent,
//                                        width: 2.0,
//                                      ),
//                                    ),
//                                  ),
...
//                                  themes[index]['name'],
//                                  style: TextStyle(
//                                    color: currentTheme == themes[index]['name'] ? theme.text3 : theme.text1,
//                                  ),
//                                ),
//                              ],
//                            );
...
//                              children: [
//                                GestureDetector(
//                                  // onTap: () => languageProvider.switchLanguage(languages[index]['name']),
//                                  child: Container(
//                                    width: itemWidth,
//                                    height: itemWidth,
//                                    decoration: BoxDecoration(
...
//                                      shape: BoxShape.circle,
//                                      border: Border.all(
//                                        // color: language == languages[index]['name'] ? Colors.blueAccent : Colors.transparent,
//                                        width: 2.0,
//                                      ),
//                                    ),
...
//                                      // color: language == languages[index]['name'] ? theme.text3 : theme.text1,
//                                      ),
//                                ),
//                              ],
//                            );
