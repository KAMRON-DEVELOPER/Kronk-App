...
// import '../../utility/url_launches.dart';
// import '../custom_theme.dart';
// import '../half_circle.dart';
//
// Column buildProfileSuccess(ProfileSuccess state, BuildContext context) {
...
//     {
//       'condition': (state.profile?.username ?? '').isNotEmpty,
...
//     },
//     {
//       "condition": (state.profile?.email ?? '').isNotEmpty,
...
//   print("banner path: ${state.profile?.banner}");
//
//   return Column(
//     children: [
//       Container(
...
//                   fit: BoxFit.cover,
//                   imageUrl: "$url${state.profile?.banner}",
...
//                     colors: [
//                       state.profile?.bannerColor?.fromHex() ??
//                           theme.background1,
//                       theme.background1,
//                       theme.background1,
//                       theme.background1,
...
//                   borderColor: state.profile?.bannerColor!.fromHex() ??
//                       theme.background1,
//                   borderWidth: 10,
//                 ),
//                 child: CachedNetworkImage(
//                   imageUrl:
//                       "http://192.168.31.42:8000${state.profile?.avatar}",
//                   fit: BoxFit.cover,
//                   width: avatarSize,
//                   height: avatarSize,
...
//                     children: [
//                       Text(
//                         "${state.profile?.followingsCount}k",
