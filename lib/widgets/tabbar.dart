...
//     return BlocProvider(
//       // create: (context) => TabsBloc(connectivityBloc: context.read<ConnectivityBloc>()),
...
//                   key: ValueKey(index),
//                   onTap: () => Navigator.pushNamed(context, "/home/${state.tabs[index]!.name}"),
//                   // onLongPress: () {
//                   //   context
//                   //       .read<TabsBloc>()
...
//                       color: index != 0 ? theme.background3 : theme.text3,
//                     ),
//                     child: Text(
...
//                     key: ValueKey(index),
//                     onTap: () => Navigator.pushNamed(context, "/home/${tabs[index]!.name}"),
//                     child: Container(
//                       alignment: Alignment.center,
//                       padding: const EdgeInsets.fromLTRB(16, 2, 16, 2),
//                       decoration: BoxDecoration(
...
//                       decoration: BoxDecoration(
//                         borderRadius: BorderRadius.circular(6),
//                         color: index != 0 ? Colors.orangeAccent : Colors.orange,
//                       ),
//                       child: Text(
//                         "${tabs[index]!.name}",
//                         style: TextStyle(
