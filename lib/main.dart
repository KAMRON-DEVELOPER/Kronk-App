    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        textTheme: TextTheme(
          ...
          displayLarge: TextStyle(fontSize: 48, color: activeTheme.text2, fontWeight: FontWeight.bold),
          displayMedium: TextStyle(fontSize: 20, color: activeTheme.text2, fontWeight: FontWeight.w700),
          displaySmall: TextStyle(fontSize: textSize3, color: activeTheme.text2, fontWeight: FontWeight.w600),
          bodyLarge: TextStyle(fontSize: 24, color: activeTheme.text2),
          bodyMedium: TextStyle(fontSize: 18, color: activeTheme.text2),
          bodySmall: TextStyle(fontSize: 14, color: activeTheme.text2.withAlpha(128)),
          titleLarge: TextStyle(fontSize: 24, color: activeTheme.text2),
          labelLarge: const TextStyle(fontSize: 24, color: Colors.purpleAccent),
          headlineLarge: const TextStyle(fontSize: 24, color: Colors.red),
        ),
